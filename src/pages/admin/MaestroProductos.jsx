...
function MaestroProductos() {
    ...
    useEffect(() => {
        Axios.get('https://calm-spire-88502.herokuapp.com/api/v1/product/list').then((res) => {
    ...
    const delete_product = (_id) => {
        Axios.delete('https://calm-spire-88502.herokuapp.com/api/v1/product/delete/' + _id)
        toast.warn('Eliminado')
    }

    const update_product = (_id) => {
        Axios.put('https://calm-spire-88502.herokuapp.com/api/v1/product/update', {
            _id: _id,
