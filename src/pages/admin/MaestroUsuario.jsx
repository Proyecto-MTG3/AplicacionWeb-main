...
const MaestroUsuario = () => {
    ...
    useEffect(() => {
        Axios.get('https://calm-spire-88502.herokuapp.com/api/v1/users/list').then((res) =>{
     ...
     const add_users_db = () => {
       ...
       Axios.post('https://calm-spire-88502.herokuapp.com/api/v1/users/add',{
         idUsers: idUsers_add,
         nombre: nombre_add,
     ...
     const delete_users = (_id) => {
       Axios.delete('https://calm-spire-88502.herokuapp.com/api/v1/users/delete/' + _id)
       toast.warn('Eliminado')
     }
   
     const update_users = (_id) => {
       Axios.put('https://calm-spire-88502.herokuapp.com/api/v1/users/update',{
         _id: _id,
