...
const MaestroVentas = () => {
    ...
    useEffect(() => {
        Axios.get('https://calm-spire-88502.herokuapp.com/api/v1/sales/list').then((res) => {
    ...
    const delete_sales = (_id) => {
        Axios.delete('https://calm-spire-88502.herokuapp.com/api/v1/sales/delete/' + _id)
        toast.warn('Eliminado')
    }

    const update_sales = (_id) => {
        Axios.put('https://calm-spire-88502.herokuapp.com1/api/v1/sales/update', {
            _id: _id,
